<%@ Page Title="" Language="C#" MasterPageFile="~/ProyectoFinal.Master" AutoEventWireup="true" CodeBehind="ConsultaTecnicos.aspx.cs" Inherits="ProyectoFinalAII.Consultas.ConsultaTecnicos" %>
        ...
        <tr>
            <td>
                &nbsp;<asp:DropDownList ID="BuscarDropDownList" runat="server" Width="131px">
                    <asp:ListItem>IdTecnicos</asp:ListItem>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="622px">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdTecnicos" DataNavigateUrlFormatString="/Registros/RegistroTecnicos.aspx?IdTecnicos={0}" Text="Editar" />
                    </Columns>
