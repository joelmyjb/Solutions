<%@ Page Title="" Language="C#" MasterPageFile="~/ProyectoFinal.Master" AutoEventWireup="true" CodeBehind="ConsultaEntregas.aspx.cs" Inherits="ProyectoFinalAII.Consultas.ConsultaEntregas" %>
        ...
        <tr>
            <td>
                &nbsp;<asp:DropDownList ID="BuscarDropDownList" runat="server" Width="131px">
                    <asp:ListItem>IdEntrega</asp:ListItem>
                </asp:DropDownList>
                &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="622px">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdEntrega" DataNavigateUrlFormatString="/Registros/RegistroEntregas.aspx?IdEntrega={0}" Text="Editar" />
                    </Columns>
