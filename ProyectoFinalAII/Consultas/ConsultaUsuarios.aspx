<%@ Page Title="" Language="C#" MasterPageFile="~/ProyectoFinal.Master" AutoEventWireup="true" CodeBehind="ConsultaUsuarios.aspx.cs" Inherits="ProyectoFinalAII.Consultas.ConsultaUsuarios" %>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="622px">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdUsuario" DataNavigateUrlFormatString="/Registros/RegistroUsuarios.aspx?IdUsuario={0}" Text="Editar" />
                    </Columns>
