<%@ Page Title="" Language="C#" MasterPageFile="~/ProyectoFinal.Master" AutoEventWireup="true" CodeBehind="ConsultaEstados.aspx.cs" Inherits="ProyectoFinalAII.Consultas.ConsultaEstados" %>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="ConsultaGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="622px">
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="IdEstado" DataNavigateUrlFormatString="/Registros/RegistroEstados.aspx?IdEstado={0}" Text="Editar" />
                    </Columns>
